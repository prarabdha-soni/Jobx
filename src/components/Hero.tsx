    ...
    <div className="flex flex-col md:flex-row min-h-[90vh] w-full">
      <div className="w-full md:w-1/2 py-10 px-6 md:px-12 lg:px-20 flex flex-col justify-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          <WhatsAppRedirect 
            type="job" 
            className="px-8 py-4 bg-teal-600 text-white rounded-md text-lg font-semibold hover:bg-teal-700 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
          >
          ...
          <WhatsAppRedirect 
            type="talent" 
            className="px-8 py-4 bg-white border-2 border-teal-600 text-teal-600 rounded-md text-lg font-semibold hover:bg-teal-50 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
          >
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-br from-orange-100 via-teal-50 to-blue-100 relative overflow-hidden">
